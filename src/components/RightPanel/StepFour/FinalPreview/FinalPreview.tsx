...
const FinalPreview: React.FC<FinalPreviewProps> = ({ editorContent, translatedEditorContent, selectedTemplate, imageFilePath, mediaQueries, selectedImage, selectedVideo }) => {
