...
const Vertical: React.FC<VerticalProps> = ({
  ...
  return (
    <div
      ...
      className={`${
        selectedTemplate.vertical && "scale-110"
      }  hover:scale-110 lg:w-[20vw] lg:h-[20vw] text-white text-xl bg-white/20 rounded-md w-[40vw] h-[40vw]  flex cursor-pointer transition ease-in duration-300`}
    >
